...
export const PrivateKeyWalletModal: React.FC<PrivateKeyWalletModalProps> = ({
  ...
  const modalContent = (
    <div className="modalLayer">
      ...
      {/* Modal content */}
      <div 
        className="modalContent rounded-xl border border-gray-800/50 bg-background/95 shadow-2xl"
        style={{ 
          width: "410px",
          maxWidth: "90vw",
          position: "fixed",
        ...
        <div className="p-5 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-10 pr-10 py-3 bg-background/70 rounded-lg border border-border focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all text-gray-100"
                autoFocus
              />
              <button
                type="button"
          ...
          <div className="flex justify-end space-x-3 mt-4">
            <Button
              variant="outline"
              onClick={onClose}
              className="text-foreground/80 hover:bg-secondary transition-all"
            >
              Cancel
            </Button>
            <Button
