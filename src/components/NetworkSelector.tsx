  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        ...
        className="bg-secondary text-white rounded-md px-3 py-1.5 border border-border text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50"
      >
